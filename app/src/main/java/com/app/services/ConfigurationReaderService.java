...
public class ConfigurationReaderService {
    ...
    public static Configuration getConfigurationFromFile(File file) throws InvalidConfigurationFileException {
    ...
    private static Configuration assignPropertiesToConfiguration(HashMap<String, Integer> properties) throws InvalidConfigurationFileException {
